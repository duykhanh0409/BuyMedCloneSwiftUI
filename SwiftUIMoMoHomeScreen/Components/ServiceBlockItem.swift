...
struct ServiceBlockItem_Previews: PreviewProvider {
    static var previews: some View {
        ServiceBlockItem(service: Datum(appCode: "", appValueCode: "", createdTime: "", lastUpdatedTime: "", value: Value(defaultParam: "", description: "", extra: "", icon: "ic_voucher", key: "", language: "", name: "khuyến mãi da tang", port: "", query: "", refID: "", sortOrder: 2, special: "", status: 1, uri: "", user: "")))
